 ...
 */
final class Version20220206134255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE verified_user verified_user TINYINT(1) DEFAULT NULL');
    }
